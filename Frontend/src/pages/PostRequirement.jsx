    ...
    function handleSubmit(event) {
        ...
        axios
            ...
            .then((data) => {
                ...
                axios
                    .get(
                        `http://localhost:3001/findUser?email=${dataReq.emailCliente}`
                    )
                    .then(({ data }) => {
                        console.log(data);
                        return data;
                    ...
                    .then((data) => {
                        if (!data.status)
                            throw alert(`No existe ${dataReq.emailCliente}`);
                        ...
                        axios
                            ...
                            .then(({ data }) => {
                                ...
                                axios.post(
                                    `http://localhost:3001/userRequirement`,
                                    {
                                        UserId: idCliente,
                                        RequirementId,
                                    }
